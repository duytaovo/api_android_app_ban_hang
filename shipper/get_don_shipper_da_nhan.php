...
INNER JOIN laptops ON laptops.id = orders_detail.laptop_id INNER JOIN transports ON orders.id = transports.order_id) where transports.status = 0 and orders.status = 1 ";
