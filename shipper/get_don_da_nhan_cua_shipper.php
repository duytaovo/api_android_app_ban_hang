...
INNER JOIN laptops ON laptops.id = orders_detail.laptop_id INNER JOIN transports ON orders.id = transports.order_id) where transports.user_id = $shipper_id  and orders.status = 2";
